(function(){
  if(window.__lessonSixRuntimeLinkFinal) return;
  window.__lessonSixRuntimeLinkFinal = true;
  ...
  if(typeof ui !== 'undefined'){
    var totalText = '1–6';
    var homeDescPack = {
      en:'Use this page as your starting point. You can open Lessons ' + totalText + ' directly, review key terms in the Glossary, or read real articles and official sources in the Source Library.',
  ...
  if(typeof currentPage !== 'undefined'){
    if(currentPage === 'home' && typeof showPage === 'function') showPage('home');
  }
})();